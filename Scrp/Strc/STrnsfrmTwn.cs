...
namespace T {
    ...
    public struct STrnsfrmTwn : ITwn {
        ...
        public STrnsfrmTwn(int id, ITrck[] iTrckArry, int nmbrOfIntrvl, float drtn, float dly, float tm, bool isExct = true, bool isDpsb = true, DActn dEnd = null) {
            _id = id;
