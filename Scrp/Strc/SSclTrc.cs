...
namespace T {
    ...
    public struct SSclTrc : ITrc {

        private Transform _tf;
        private SVct3[] _stpArr;
        private float _mX, _mY, _mZ;

        public SSclTrc(Transform tf, SVct3 sOrg, SVct3 sTrg, int nOI) {
            _tf = tf;
        ...
        public void Trd(int stp) {
            _tf.localScale = new Vector3(_stpArr[stp].X, _stpArr[stp].Y, _stpArr[stp].Z);
        }
    }
}